...
public class Daftarmenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //memebuat array list baru dengan nama daftar
        daftarmenu = new ArrayList<>();
        //mendapat penanganan recycler view
        recv = findViewById(R.id.daftarmenu);
        recv.setHasFixedSize(true);
        //kondisi ketika orientasi menjadi landscape
        if(getResources().getConfiguration().orientation== Configuration.ORIENTATION_LANDSCAPE {
            //maka akan menampilkan 2 grid
            recv.setLayouManager(new GridLayoutManager( context:daftarmenu.this, spanCount:2));
            //jika orientasi menjadi menampilkan
        }else {
            //maka akan menampilkan satu grid saja
            recv.setLayoutManager (new GridLayoutManager ( context: daftarmenu.this, spanCount 1));
        }
